...
final public class Text {
    ...
    public static String get(String key){
        ...
        System.out.println("Такого значения нет"); // for debug
        return "";
    }
    ...
    public static void init(){
        ...
        data.put("ERROR_IS_EXISTS","Такая запись уже существут!");
        data.put("ERROR_DATE_FORMAT","Некоректный ыормат даты!");
        ...
        data.put("ERROR_RATE_INCORRECT","Вы не выбрали значение курса!");
        data.put("ERROR_AMOUNT_FORMAT","Неккоректный формат суммы!");
        data.put("ERROR_NO_BASE_CURRENCY","Необходима базовая валюта, установите сначало этот параметр в другой валюте, потом он снимется с текущей валюты автоматически");
